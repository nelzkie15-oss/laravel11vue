...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const showProduct = () => {
      const res = form.get(route("products.update", props.product.id));
      if (res) {
        form.reset();
      }
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), { title: "Show Product" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mx-4 mt-4"${_scopeId}><div class="flex justify-between"${_scopeId}><h5 class="mb-2"${_scopeId}>Show Product</h5>`);
            ...
            return [
              ...
              createVNode("div", { class: "mx-4 mt-4" }, [
                createVNode("div", { class: "flex justify-between" }, [
                  createVNode("h5", { class: "mb-2" }, "Show Product"),
                ...
                createVNode("form", {
                  onSubmit: withModifiers(($event) => showProduct(), ["prevent"])
                }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Main/Product/show.vue");
